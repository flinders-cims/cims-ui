document.addEventListener("DOMContentLoaded", function() {
    ...
    const rejectedRequestsApiUrl = `https://flinders-cims-api-dev.azurewebsites.net/cims/service-requests/get-all/manager/geor6375@flinders.edu.au/status/rejected`;
    const pendingRequestsApiUrl= `https://flinders-cims-api-dev.azurewebsites.net/cims/service-requests/get-all/manager/geor6375@flinders.edu.au/status/pending`;
    const approvedRequestsApiUrl= `https://flinders-cims-api-dev.azurewebsites.net/cims/service-requests/get-all/manager/geor6375@flinders.edu.au/status/approved`;
    const closedRequestsApiUrl= `https://flinders-cims-api-dev.azurewebsites.net/cims/service-requests/get-all/manager/geor6375@flinders.edu.au/status/Closed`;
