document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchApprovedSR() {
        ...
        const apiUrl = `https://flinders-cims-api-dev.azurewebsites.net/cims/service-requests/get-all/${userId}/status/approved`;
        ...
        function fetchServiceRequestDetails(srId) {
            ...
            fetch(apiUrl)
                ...
                .then(data => {
                    ...
                    document.getElementById('approved_date').innerText = `Date Created: ${data.dateApproved}`;
