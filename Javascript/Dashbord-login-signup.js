document.addEventListener("DOMContentLoaded", function () {
    ...
    loginBtn.addEventListener("click", function () {
        window.location.href = "../src/Login.html"; // Replace with the login page URL
    });
});
...
document.getElementById("loginForm").addEventListener("submit", function(event) {
    ...
    const authusername = 'CimsAdmin';
    const authpassword = 'CimsAdmin';
...
console.log(credentials);
    ...
    fetch('https://flinders-cims-api-dev.azurewebsites.net/cims/user/login', {
    method: 'POST',
    headers: {
